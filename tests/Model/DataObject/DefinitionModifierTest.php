...
class DefinitionModifierTest extends ModelTestCase
{
    ...
    {
        $fieldcollection = \OpenDxp\Model\DataObject\Fieldcollection\Definition::getByKey('unittestfieldcollection');
        /** @var ClassDefinition\Layout\Panel $panel */
    ...
    {
        $objectbrick = \OpenDxp\Model\DataObject\Objectbrick\Definition::getByKey('unittestBrick');
        /** @var ClassDefinition\Layout\Panel $panel */
