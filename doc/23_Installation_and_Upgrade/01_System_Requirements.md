...
> Also have a look at our official [Docker images](https://hub.docker.com/r/open-dxp/opendxp) and the
> docker-compose files in our [skeleton](https://github.com/open-dxp/skeleton/blob/1.x/docker-compose.yaml).  
...
OpenDXP utilizes the Symfony Messenger for various background processes to ensure efficient handling of tasks. As the number of OpenDXP elements grows, the need for a more robust and scalable queue system becomes evident. RabbitMQ is recommended in these scenarios for its exemplary performance and scalability. It excels in managing high volumes of messages and complex workflows, making it the preferred choice for systems that demand reliability and efficiency at scale.

Please follow [Symfony Messenger](../01_Getting_Started/02_Advanced_Installation_Topics/01_Symfony_Messenger.md) for more information about OpenDXP messenger. For an example configuration, refer to [this link](https://github.com/open-dxp/skeleton/blob/1.x/.docker/messenger.yaml).
...
OpenDXP supports always the latest 2 versions of all 4 major desktop browsers at the time of a release. 
...
*Note:* Microsoft Internet Explorer 11 won`t be supported from OpenDXP 6.0.0 or higher. More details **[here](https://github.com/open-dxp/opendxp/issues/2989)**.

### System Requirements Check

A tool that gives you an overview of required and optional system requirements for running OpenDXP Application.
...
```bash
bin/console opendxp:system:requirements:check
```
