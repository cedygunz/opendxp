...
To create or edit perspectives and custom views within the OpenDXP backend UI use the [perspective editor](https://github.com/open-dxp/perspective-editor) bundle.
    ...
    custom_views:
        definitions:
            87705013-edb9-c9ec-0f5e-c3ee45ca4459:
                ...
                icon: /bundles/opendxpadmin/img/flat-color-icons/vip.svg
                where: ''
    ...
    custom_views:
        definitions:
            186632eb-5ad3-6ac6-61f8-7a75e64f2204:
                ...
                icon: /bundles/opendxpadmin/img/flat-color-icons/camera_identification.svg
                where: ''
